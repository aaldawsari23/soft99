            ...
            {isOpen && (
                <div className="absolute top-full right-0 mt-1 w-48 bg-neutral-900 border border-white/10 rounded-lg shadow-xl z-20 py-1 max-h-60 overflow-y-auto">
                    <button
                        ...
                        className={`w-full px-4 py-2 text-right text-sm transition-colors ${value === 'all' ? 'text-red-500 bg-red-500/10' : 'text-neutral-300 hover:bg-white/5'
                            }`}
                    >
                        الكل
                    </button>
                    {options.map(option => (
                        <button
                            ...
                            className={`w-full px-4 py-2 text-right text-sm transition-colors ${value === option.id ? 'text-red-500 bg-red-500/10' : 'text-neutral-300 hover:bg-white/5'
                                }`}
                        >
                            {option.label}
                        </button>
