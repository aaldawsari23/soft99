// =============================================================================
// 📁 src/app/(public)/catalog/page.tsx - صفحة الكتالوج المبسطة
// =============================================================================
...
// =============================================================================
// 📁 src/components/CatalogContent.tsx - المحتوى المبسط
// =============================================================================
...
// =============================================================================
// 📁 src/components/products/ProductGrid.tsx - Grid بسيط
// =============================================================================
  ...
  if (products.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        <div className="text-6xl mb-4">📦</div>
        <h3 className="text-xl font-bold text-white mb-2">لا توجد منتجات</h3>
        <p className="text-neutral-500">لم يتم العثور على منتجات في هذا القسم</p>
      </div>
    );
  }
